...
Examples:
  ...
  """
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument('-i', '--input-size', nargs='+', type=int, default=[102, 64, 64],
                            help="list type, record the input size of Pfam, Clan and description.")

    def run(self, inputs, output, model, target, classes, config, log, validation, verbose, input_size):
